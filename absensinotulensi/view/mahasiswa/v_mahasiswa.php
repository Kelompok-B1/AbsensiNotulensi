...
<?php
  ...
  if($_SESSION['status_login']!="sudah_login"){
    header("location:../login_mahasiswa.php?pesan=belum_login");
}
        ...
        <div class="d-flex" id="wrapper">
            ...
            <div class="border-end bg-white" id="sidebar-wrapper">
                ...
                <div class="list-group list-group-flush">
                    <a class="list-group-item list-group-item-action list-group-item-light p-3" href="v_mahasiswa_tampil_abs.php">Absensi</a>
                    <a class="list-group-item list-group-item-action list-group-item-light p-3" href="v_mahasiswa_.tampil_ntl.php">Notulensi</a>
                </div>
            </div>
                            ...
                            <ul class="navbar-nav ms-auto mt-2 mt-lg-0">
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                        ...
                                        <a class="dropdown-item" href="../logout_mahasiswa.php">Logout</a>
                                    </div>
                                </li>
                            </ul>
                        </div>
