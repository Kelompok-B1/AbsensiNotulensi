    ...
    <?php 
       ...
       # $arai = $collection ->inventory->aggregate({$project=>{colors=>{$size=>array('$colors')}}});
        ...
        foreach ($matakuliah as $mkl){
            ...
            echo "<td><a href='v_admin_edit_mkl.php?id=".$mkl->_id."' class='btn btn-info' >
            <i class='fa fa-pencil'></i> Edit</a>   
                <a href='v_admin_delete_mkl.php?id=".$mkl->_id."'class='btn btn-danger'> <i class='fa fa-trash'></i> Delete</a></td>";
            echo "</tr>";
